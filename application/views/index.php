...
<head>
	...
	<meta name="keywords" content="麦金思,麦金思网,麦金思教育门户,麦金思英语,麦金思官网,麦金思英语培训,麦金思教育科技集团,麦金思官方网站,麦金思培训,麦金思集团" />
    ...
    <div class="row">
        <div id="content" class="col-md-10 col-md-offset-1">
            <div class="feature col-md-12 col-sm-12">
                <div class="title">
                    <h1 class="col-md-4 col-md-offset-4 col-sm-8 col-sm-offset-2 text-center">麦金思特色</h1>
                    <p class="col-md-8 col-md-offset-2 col-sm-10 col-sm-offset-1 text-center">McGins English Education Features</p>
                </div>
                <ul>
...
<script>
    $(document).ready(function(){
        $('#content .feature').css({'background-image': 'url(<?php echo $carouselInfo[0] -> index_feature_bg ?>)'});
    });
</script>
</body>
</html>
