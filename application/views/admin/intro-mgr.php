                    ...
                    foreach($introInfo as $intro){
                        ...
                        <tr>
                            ...
                            <!--<td>
                                <div class="am-btn-toolbar">
                                    <div class="am-btn-group am-btn-group-xs">
                                        <button class="btn-edit am-btn am-btn-default am-btn-xs am-text-secondary" data-id="<?php /*echo $intro -> id; */?>"><span class="am-icon-pencil-square-o"></span> 编辑</button>
                                        <button class="btn-delete am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only" data-id="<?php /*echo $intro -> id; */?>"style=" margin-left:0px;"><span class="am-icon-trash-o" style="width:12px;"></span> 删除</button>
                                    </div>
                                </div>
                            </td>-->
                        </tr>
